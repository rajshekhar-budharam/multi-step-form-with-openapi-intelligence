...
import { t } from '../../i18n';
import { validateFamilyFinancialInfo } from '../../utils/validation';
import { MARITAL_STATUS_OPTIONS, EMPLOYMENT_STATUS_OPTIONS, HOUSING_STATUS_OPTIONS } from '../../utils/constants';
...
export const FamilyFinancialInfo = ({ value, onChange, lang = 'en', errors = {}, showErrors = false })  => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <label>
          ...
          <Select
            ...
            lang={lang}
          />
          {showErrorFor('maritalStatus') && errors.maritalStatus && <div className="text-xs text-red-600">{errors.maritalStatus}</div>}
        </label>
        ...
        <label>
          ...
          <Select
            ...
            lang={lang}
          />
          {showErrorFor('employmentStatus') && errors.employmentStatus && <div className="text-xs text-red-600">{errors.employmentStatus}</div>}
        </label>
        ...
        <label>
          ...
          {showErrorFor('monthlyIncome') && errors.monthlyIncome && <div className="text-xs text-red-600">{errors.monthlyIncome}</div>}
        </label>
        ...
        <label className="col-span-1 md:col-span-2">
          ...
          <Select
            ...
            lang={lang}
          />
          {showErrorFor('housingStatus') && errors.housingStatus && <div className="text-xs text-red-600">{errors.housingStatus}</div>}
        </label>
      </div>
    </section>
  )
